...
## Insight 2
We were not able to find a good solution with our 'single-shot' D-optimal design because we considered too few different configurations. For future reduced designs, a funnel approach could work better: first, use Single-Shot testing to discard the bottom 80% of configurations. Then, conduct multi-lap confirmation runs (5–8 laps) on the top candidates to penetrate the 0.6 s noise floor and find a better solution.
