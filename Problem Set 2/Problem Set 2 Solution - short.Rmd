...
The Figure below displays the ACF and PACF of Delta log(Total Sales) for both counties.
Overall, the plots do not suggest strong or long-lasting autocorrelation.
At all positive lags, the sample autocorrelations are small and lie within the approximate 95% confidence bands, and the PACF does not show any pronounced spikes.
