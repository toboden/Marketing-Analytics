...
##############################
library(reticulate)
use_virtualenv('path_to_env', required = TRUE)
```
...
# Dateinamen anpassen
#rename_files(os.listdir(audio_dir), track_table) # Uncomment when running model!
```
### Data preparation
...
#features extrahieren # Uncomment when running model
rows = []
